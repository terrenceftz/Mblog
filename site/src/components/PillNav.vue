...
<template>
  <div ref="navItemsRef" class="pill-nav-items">
    <a class="pill-logo" href="/" aria-label="首页">
      <svg id="_图层_1" data-name="图层 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 681.51 197.5">
        <defs>
          <style>
            .cls-1 {
              fill: hsl(275.93, 88.66%, 51.96%);
            }
            ...
            .cls-2 {
              fill: hsl(275.93, 88.66%, 61.96%);
            }
          </style>
        </defs>
        <g>
          <path class="cls-2" d="M161.81,2.12L9.42,122.73c-12.68,10.04-11.87,27.8-1.67,37.48l67.58-17.41c12.25-3.16,22.75,9.19,17.68,20.78l-5.5,12.54c24.74-1.3,46.71-18.02,53.95-42.66L177.02,12.38c2.65-9.01-7.85-16.09-15.21-10.26Z"/>
          <path class="cls-2" d="M20.78,166.59c-5.27-.86-9.66-3.18-13.03-6.38h0s30.54,29.09,30.54,29.09c14.91,14.2,39.39,9.28,47.65-9.57l1.58-3.61c-4.2.22-8.48.01-12.79-.69l-53.94-8.84Z"/>
          <path class="cls-1" d="M75.33,142.81L7.75,160.21c3.37,3.2,7.76,5.51,13.03,6.38l53.94,8.84c4.3.71,8.59.91,12.79.69l5.5-12.54c5.08-11.59-5.42-23.93-17.68-20.78Z"/>
        </g>
        <g>
          <path class="cls-2" d="M262.99,161.74v-49.32l-23.53,49.32h-11.31l-23.08-49.32h-.45c0,2.42.15,6.04.45,10.86v38.46h-11.31v-58.37h16.29l23.98,49.32,23.53-49.32h16.29v58.37h-10.86Z"/>
          <path class="cls-2" d="M290.14,103.37h36.65c14.78.3,22.47,5.13,23.08,14.48,0,5.73-3.62,9.81-10.86,12.22,10.25,2.71,15.38,7.54,15.38,14.48,0,4.23-1.97,7.85-5.88,10.86-5.13,4.23-12.67,6.33-22.62,6.33h-35.74v-58.37ZM301.45,127.81h19.91c11.76.3,17.49-2.86,17.19-9.5,0-5.73-5.73-8.6-17.19-8.6h-19.91v18.1ZM301.45,154.95h23.98c11.46-.3,17.34-3.77,17.65-10.41,0-6.63-6.64-9.95-19.91-9.95h-21.72v20.36Z"/>
          <path class="cls-2" d="M433.57,154.95c-7.24,5.43-17.19,8.14-29.86,8.14-13.57,0-23.98-2.86-31.22-8.6-6.04-5.73-9.21-12.51-9.5-20.36.3-9.95,4.82-17.94,13.57-23.98,6.93-4.22,15.98-6.33,27.15-6.33,12.36,0,22.17,2.71,29.41,8.14,6.94,6.04,10.55,13.43,10.86,22.17-.3,8.45-3.78,15.38-10.41,20.81ZM403.71,110.16c-18.4.61-28.05,8.6-28.96,23.98.91,14.48,10.56,22.02,28.96,22.62,18.1-.6,27.75-8.14,28.96-22.62-1.21-15.08-10.86-23.08-28.96-23.98Z"/>
          <path class="cls-2" d="M468.41,161.74h-11.31v-58.82h11.31v28.5l40.27-28.5h15.84l-34.84,23.98,35.74,34.84h-14.93l-28.96-29.41-13.12,8.6v20.81Z"/>
          <path class="cls-2" d="M596.45,161.74h-61.08v-59.27h60.18v6.79h-48.87v18.55h45.25v7.24h-45.25v19.46h49.77v7.24Z"/>
